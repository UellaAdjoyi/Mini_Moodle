<nav class="navbar navbar-expand-lg fixed-top ">
        <div class="container-fluid">
            ...
            <?php
                    if($qui=="admin"){
                        echo '<a class="nav-item nav-link" href="home_page.php">Tableau de bord</a>
                        <a class="nav-item nav-link" href="catalogue.php">Catalogue</a>';
                    }
                    else {
                        echo "<a class='nav-item nav-link' href='../../index.php'>Accueil</a>
                        <a class='nav-item nav-link' href='../profAdmin/page_ue_prof.php'>Choix d'UE</a>
                        <a class='nav-item nav-link' href='#'>Liste des UEs</a>
                        <a class='nav-item nav-link' href='../profAdmin/post_ue.php'>Posts</a>";
                    }
                ?>
            ...
            <div class="d-flex align-items-center">
                <?php
                    if($qui=="admin"){
                        echo "<span><a class='nav-item nav-link btn btn-success' href='page_ue_prof.php'>Session prof</a></span>";
                    }
                    else {
                        echo "<span><a class='nav-item nav-link btn btn-success' href='catalogue.php'>Session Admin</a></span>";
                    }
                ?>
